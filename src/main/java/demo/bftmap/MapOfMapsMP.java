/**
Copyright (c) 2007-2013 Alysson Bessani, Eduardo Alchieri, Paulo Sousa, and the
authors indicated in the @author tags
...
public class MapOfMapsMP implements Serializable {
    ...
    public Map<Integer, byte[]> addTable(Integer key,
                                         Map<Integer, byte[]> table) {
    ...
    public int getNumOfTables() { return tableMap.size(); }
