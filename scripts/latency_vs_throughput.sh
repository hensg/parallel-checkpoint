...
function start_experiment() { 
    ...
    local experiment_dir=experiments/name=latencyvsthroughput/datetime=$datetime/clients=$client_num_threads/partitioned=${partitioned}/run=$run/read=${client_p_read}/conflict=${client_p_conflict}
